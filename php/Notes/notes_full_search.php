...
if ($country == ""){
	echo "USAGE: \n<br>
		  http://server/path/notes_full_search.php?country=xx (from a browser) \n<br> 
		  php -f notes_full_search.php country=xx (from a command line) \n<br>
		  ";
	die();
}
...
//EXIT			
//		if ($row > 10) break;	// STOP for TEST
		if ($row < 1400) continue;
		if ($row > 2800) break;	// STOP for TEST
//EXIT			
...
//		$DEBUG .= "## SEARCH RESULT: ".print_r($note_respsearch,true)." ##</br>\n";
		...
		if ($note_id != "") {
			...
			$DEBUG .= "NOTE FOUND ". $note_id ." # ". $data[0] ." ##</br>\n";
